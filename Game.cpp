...
Game::Game() :
    ...
    m_moveEastOption(Room::JoiningDirections::South, PlayerOptions::GoEast, "Go East"),
    m_moveSouthOption(Room::JoiningDirections::East, PlayerOptions::GoSouth, "Go South"),
